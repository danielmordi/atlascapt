...
@section('content')
    ...
    <div class="auto-container my-4" style="padding: 100px 0px 150px;">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Stake Farm LTD, 8th Floor Cheapside London,United kingdom.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Stake Farm, accessible from <a href="https://stakesfarm.com/"
                        rel="external nofollow noopener" target="_blank">https://stakesfarm.com/</a></p>
            </li>
            <li>
        ...
        <ul>
            ...
            <li>
                <p>By mail: 2547 Larry Street San Francisco CA</p>
            </li>
        </ul>
    </div>
